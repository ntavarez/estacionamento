...
public class EstacionamentoTest {
	...
	public void deveRetornarErroQuandoMotoristaNaoTemHabilitacao() {
		Motorista.builder().withNome("Ada").withIdade(17).withPontos(10).build();
	}

	@Test(expected = NullPointerException.class)
	public void deveRetornarErroQuandoMotoristaNaoTemNome() {
		Motorista.builder().withIdade(17).withPontos(10).withHabilitacao("12213").build();
	}

	@Test(expected = IllegalArgumentException.class)
	public void deveRetorarErroQuandoIdadeNegativa() {
		Motorista.builder().withIdade(-1);
	}

	@Test(expected = IllegalArgumentException.class)
	public void deveRetorarErroQuandoPontosNegativos() {
		Motorista.builder().withPontos(-1);
	}
	...
	public void naoDeveTerMotoristaDeMenor() {
		Motorista motorista = Motorista.builder().withNome("Ada").withIdade(17).withPontos(10).withHabilitacao("1231")
				.build();
	...
	public void naoDeveEstacionarMotoristaSemPontos() {
		Motorista motorista = Motorista.builder().withNome("Ada").withIdade(25).withPontos(30).withHabilitacao("1231")
				.build();
	...
	public void deveEstacionar() {
		Motorista motorista = Motorista.builder().withNome("Ada").withIdade(20).withPontos(3).withHabilitacao("1231")
				.build();
		Carro carro = Carro.builder().withCor(Cor.BRANCO).withPlaca("123").withMotorista(motorista).build();
	...
	public void naoDeveUltrapassarEstacionamento() {
		Motorista ada = Motorista.builder().withNome("Ada").withIdade(20).withPontos(3).withHabilitacao("1231").build();

		Carro carroBranco = Carro.builder().withCor(Cor.BRANCO).withPlaca("123").withMotorista(ada).build();

		estacionamento.estacionar(carroBranco);

		for (int indice = 1; indice <= 10; indice++) {

			Motorista motorista = Motorista.builder().withNome("Motorista " + indice).withIdade(20).withPontos(3)
					.withHabilitacao(Long.toString(current().nextLong())).build();
	...
	public void casoPrimeiroMotoristaSejaSeniorEleNaoDeveSair() {
		...
		Motorista ada = Motorista.builder().withNome("Ada").withIdade(60).withPontos(3).withHabilitacao("1231").build();
		...
		for (int indice = 1; indice <= 10; indice++) {
			...
			Carro carro = Carro.builder().withCor(getCor()).withPlaca("123").withMotorista(motorista).build();
	...
	public void casoTodosSejamSeniorONovoMotoristaNaoTeraVaga() {
		...
		for (int indice = 1; indice <= 10; indice++) {
			...
			Motorista motorista = Motorista.builder().withNome("Motorista " + indice).withIdade(60).withPontos(3)
					.withHabilitacao(Long.toString(current().nextLong())).build();
