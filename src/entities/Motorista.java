...
public class Motorista {
    ...
    private Motorista(String nome, int idade, int pontos, String habilitacao) {
    	if (nome == null || habilitacao == null) throw new NullPointerException("Dados invalidos.");
    	if (idade < 18) throw new EstacionamentoException("Proibido motorista menor de idade!");
    	if (pontos > 20) throw new EstacionamentoException("Limite de pontos estourado!");
    ...
    public boolean equals(Object outro) {
        ...
        Motorista motorista = (Motorista) outro;
