...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
    	if (placa == null) throw new NullPointerException("Placa inválida.");
    	if (cor == null) throw new NullPointerException("Cor inválida.");
    	if (motorista == null) throw new EstacionamentoException("O carro precisa de um motorista.");
